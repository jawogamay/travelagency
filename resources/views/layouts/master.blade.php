...
<div class="wrapper" id="app">
  ...
  <nav class="main-header navbar navbar-expand bg-white navbar-light border-bottom">
    ...
    <!-- SEARCH FORM -->
    <form class="form-inline ml-3"  class="vld-parent" ref="formContainer">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
            ...
            <li class="nav-item has-treeview">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <router-link to="/salesconsultant" class="nav-link">
                    <i class="fas fa-users nav-icon"></i>
                    <p>Sales Per Travel Consultant</p>
                  </router-link>
                </li>
          ...
          <li class="nav-item">
                <router-link to="/booklet" class="nav-link">
                    <i class="nav-icon fas fa-book-open teal"></i>
                    <p>
                        Booklet
                    </p>
                </router-link>
